...
{
    int *num_jobs = (int*)malloc(sizeof(*num_jobs));
    assert(num_jobs);
    *ctx = num_jobs;

    struct codes_jobmap_params_dummy const * p = (codes_jobmap_params_dummy const*)params;
...
{
    int const * num_jobs = (int const*)ctx;
